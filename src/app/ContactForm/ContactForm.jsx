...
export default function ContactForm() {
    ...
    return (
        <div className="contact-container bg-white p-10 flex flex-col">
            <h2 className="contact-heading text-black text-sm sm:pb-4">CONTACT</h2>
            <h1 className="text-black">Get in touch</h1>
            <div className="contact-instruction pt-1 sm:pb-4">
            ...
            <form action="mailto:north@northhardwoodfloors.com" method="post" encType="text/plain" className="flex flex-col">
                ...
                <input type="submit" value="SUBMIT" className=" bg-gray-300 hover:bg-gray-200 text-gray-500 font-bold py-2 px-4 rounded w-24 text-sm sm:mt-4"/>
            </form>
        </div>
    )
}